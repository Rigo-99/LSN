...
void Popolazione :: Svuota_Popolazione(){
	popolo.clear();
}
...
void Popolazione :: Aggiungi_Individuo(Individuo nuovo){

        popolo.push_back(nuovo);
...
void Individuo :: Stampa(std::string nome_file){
...
void Mappa :: Stampa(std::string nome_file){
